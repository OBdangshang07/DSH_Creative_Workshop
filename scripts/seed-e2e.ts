...
const fixture = (id: string, name: string, stars: number): GitHubPluginRecord => ({
  ...
  version: '1.2.0', releaseNotes: { version: '1.2.0', title: `${name} 1.2.0`, summary: 'A traceable browser-test release for the fixed revision.', changes: [{ type: 'changed', text: 'Updated the verified browser-test bundle.' }], breakingChanges: [], sourceType: 'declared', sourceUrl: `https://github.com/dsh-e2e/${id.split('.').at(-1)}/releases/tag/v1.2.0`, collectedAt: '2026-08-20T00:00:00Z' },
